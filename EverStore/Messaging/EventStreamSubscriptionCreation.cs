...
{
    internal class EventStreamSubscriptionCreation: IEventStreamSubscriptionCreation
    {
        ...
        public EventStreamSubscriptionCreation(ITopicCreation topicCreation, ISubscriptionCreation subscriptionCreation, IConventionIdFactory conventionIdFactory)
        {
